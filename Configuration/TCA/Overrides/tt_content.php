...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPlugin(
    [
        'label' => 'Youtube',
        'value' => 'youtubegdprembed_youtube',
        'icon' => 'tx-youtube-gdprembed-video',
    ],
    'CType',
    'youtube_gdprembed'
);

$GLOBALS['TCA']['tt_content']['types']['youtubegdprembed_youtube'] = [
    'showitem' => '
    ...
    ',
    'previewRenderer' => \SaschaSchieferdecker\YoutubeGdprembed\Preview\YoutubePreviewRenderer::class,
];
...
$GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['youtubegdprembed_youtube'] = 'tx-youtube-gdprembed-video';
